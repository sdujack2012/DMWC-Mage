...
function Mage.Settings()
	...
	UI.AddRange("Kite HP %", "the HP above which Kite", 0, 100, 1, 35)
	UI.AddToggle("Wand Execute", "Will Execute Targets with Wand", true, true)
	UI.AddRange("Wand Execute %", "Health limit", 0, 30, 1, 20)
	UI.AddTab("Defensive")
	UI.AddToggle("Ice Barrier", "Frost Barrier", true)
	UI.AddRange("Ice Barrier HP", "HP to cast Frostbolt", 0, 100, 1, 35)
	...
	UI.AddToggle("Use Cone Of Cold", nil, false)
	UI.AddRange("Cone Of Cold Mana", "Minimum mana pct to cast Cone Of Cold", 0, 100, 1, 60)
	
	UI.AddTab("Survival")
	UI.AddToggle("Mana Gem Usage", "Use Mana Gem?", false)
	UI.AddRange("Gem Mana", "What mana to use Gem at", 0, 100, 1, 25)
	UI.AddToggle("Use bandage", "Use bandage", false)
	UI.AddRange("Use bandage HP", "What HP to use bandage", 0, 100, 1, 25)
	
	UI.AddTab("Utility")
	UI.AddToggle("Evocation", "Evocate under certain conditions?", true)
